...
const int _defaultOrder = 1;
const IconData _defaultIcon = Icons.format_bold;
const String _defaultTooltip = 'Bold';
...
const String _defaultPlaceholder = 'bold text';

class ToolbarItemBold extends ToolbarItemButton
